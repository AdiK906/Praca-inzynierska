    ...
    public static class Extensions
    {
        ...
        public static IApplicationBuilder UseCore(this IApplicationBuilder app)
        {
            app.UseJaeger()
                ...
                .UseAuthentication()
                .UseRabbitMq()
                .SubscribeEvent<ReservationApproved>()
                .SubscribeEvent<TransportReserved>()
                .SubscribeEvent<TransportRejected>()
                .SubscribeEvent<HotelReserved>()
                .SubscribeEvent<HotelRejected>()
                .SubscribeEvent<AtractionReserved>()
                .SubscribeEvent<AtractionRejected>();
